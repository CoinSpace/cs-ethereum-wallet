...
Wallet.prototype.unlock = function(privateKey) {
  this.etherWallet = EthereumWallet.fromPrivateKey(Buffer.from(privateKey, 'hex'));
  this.isLocked = false;
};
...
Wallet.prototype.dumpKeys = function() {
  ...
  return {
    public: this.etherWallet.pubKey.toString('hex'),
    private: this.etherWallet.privKey.toString('hex')
  };
};
